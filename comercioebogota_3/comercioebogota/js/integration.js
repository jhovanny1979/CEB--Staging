  ...
  async function setupAdmin() {
    ...
    async function loadAdminData() {
      try {
        ...
        adminState.pendingReceipts = responses[1] || [];
        adminState.businesses = responses[2] || [];
        adminState.clients = responses[3] || [];
        adminState.promotions = responses[4] || [];
        adminState.admins = responses[5] || [];
        adminState.plans = responses[6] || [];
        if (responses[7]) {
          adminState.platformSettings = responses[7];
        }
